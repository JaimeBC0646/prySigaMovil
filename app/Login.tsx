...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      if (data.success) {
        // Accede al arreglo que trae 'data'
  ...
  return (
    <LinearGradient colors={['#0077cc', '#e6f7ff']} style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <TouchableOpacity onPress={() => router.replace('/RecuperarContra')}>
      ...
      <TouchableOpacity
        ...
        onPress={() => router.replace('/Registro')}  // Redirigir registro
      >
