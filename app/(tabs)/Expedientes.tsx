...
import FormSolicitarExpediente from '@/components/SolicitarExpediente';
    ...
    <View>
        ...
        <Image
          ...
          source={
            selectedExpediente === index
              ? require('../../assets/images/display_upArrow.png')
              : require('../../assets/images/display_downArrow.png')
          }
      ...
      {selectedExpediente === index && (
        <View style={styles.optionMenu}>
          ...
          <TouchableOpacity style={styles.optionButton} onPress={() => {setModalSolicitud(true); setSelectedExpediente(item);}}>
    ...
    <LinearGradient colors={['#0077cc', '#e6f7ff']} style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.viewMessagge}>
          <Text style={styles.welcomeMessage}>Bienvenido Sec. {userData?.nombre || 'user'}</Text>
        </View>
      </View>
      ...
      <View style={styles.btnReload}>
        ...
        <TouchableOpacity onPress={() => fetchExpedientes()}>
          <Image source={require('../../assets/images/reloadIcon.png')} style={styles.reloadIcon} alt='reloadIcon' />
        </TouchableOpacity>
      </View>
